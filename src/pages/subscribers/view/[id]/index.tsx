  ...
  const { data, error, isLoading, mutate } = useSWR<SubscriberInterface>(
    ...
    () =>
      getSubscriberById(id, {
        relations: ['user', 'media', 'subscription'],
      }),
  );
              ...
              {hasAccess('media', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/media/create?subscriber_id=${data?.id}`}>
              ...
              {hasAccess('subscription', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/subscriptions/create?subscriber_id=${data?.id}`}>
                      <Button colorScheme="blue" mr="4" as="a">
                        Create
                      </Button>
                    </NextLink>
